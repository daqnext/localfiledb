...
//		if cv.operator==quickle||cv.operator==quickgt||cv.operator==quickeq||cv.operator==quickge||cv.operator==quicklt {
//			isquickquery=true
//			break
//		}
//	}
...
//
//				if isquickquery {
//					k,v=s.quickSeedCursor(cursor,criteria)
//				}else{
//					// k, v = cursor.First()
...
//
//				if isquickquery {
//					k,v=s.quickNextCursor(cursor,criteria)
//				}else{
//					k, v = cursor.Next()
//				}
//
